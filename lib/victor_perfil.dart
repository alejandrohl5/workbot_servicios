...
class perfil extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Column(
          children: <Widget>[perfil1(), botonGuardarCambios()],
        ),
      ),
    );
  }
  ...
  Container _edad() {
    return Container(
      ...
      child: TextFormField(
        style: TextStyle(fontSize: 20),
        decoration: InputDecoration(border: InputBorder.none, hintText: '25'),
      ),
    );
  }
  ...
  Container _telefono() {
    return Container(
      ...
      child: TextFormField(
        style: TextStyle(fontSize: 20),
        decoration:
            InputDecoration(border: InputBorder.none, hintText: '959150750'),
      ),
    );
  }
